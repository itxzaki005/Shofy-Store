...
<!-- Mirrored from.php.weblearnbd.net/shofy-prv/shofy/index-4.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Oct 2023 08:17:05 GMT -->
<head>
      <meta charset="utf-8">
   ...
   <body>
      ...
      <div class="cartmini__area cartmini__style-brown  tp-header-sticky has-dark-logo">
     ...
     <!-- cart mini area end -->
      ...
      <main>
            ...
            <div class="tp-slider-active-4 khaki-bg">
               <div class="tp-slider-item-4 tp-slider-height-4 p-relative khaki-bg d-flex align-items-center" >
                  <div class="tp-slider-thumb-4">
                     <img src="assets/img/slider/4/slider-1.png" alt="">
                  ...
                  <div class="tp-slider-video-wrapper">
                     ...
                     <div class="tp-slider-video transition-3">
                        ...
                        <video loop>
                           <source type="video/mp4"  src="the_video_link.php">
                        </video>
                     </div>
                     <!-- video button -->
                     <div class="tp-slider-play">
                        ...
                        <button type="button" class="tp-slider-play-btn tp-slider-video-move-btn tp-video-toggle-btn">
                           <img class="text-shape" src="assets/img/slider/4/shape/rounded-test.png" alt="">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-8">
                           <div class="tp-slider-content-4 p-relative z-index-1">
                              ...
                              <div class="tp-slider-btn-4">
                                 <a href="shop.php" class="tp-btn tp-btn-border tp-btn-border-white">Discover Now</a>
                              </div>
                           </div>
                        </div>
                     </div>
               ...
               <div class="tp-slider-item-4 tp-slider-height-4 p-relative khaki-bg d-flex align-items-center" >
                  <div class="tp-slider-thumb-4">
                     <img src="assets/img/slider/4/slider-2.png" alt="">
                     <div class="tp-slider-thumb-4-shape">
                        <span class="tp-slider-thumb-4-shape-1"></span>
                        <span class="tp-slider-thumb-4-shape-2"></span>
                     </div>
               ...
               <div class="tp-slider-item-4 tp-slider-height-4 p-relative khaki-bg d-flex align-items-center" >
                  <div class="tp-slider-thumb-4">
                     <img src="assets/img/slider/4/slider-3.png" alt="">
                     <div class="tp-slider-thumb-4-shape">
                        <span class="tp-slider-thumb-4-shape-1"></span>
                        <span class="tp-slider-thumb-4-shape-2"></span>
                     </div>
                     ...
                     <div class="tp-slider-nav-active">
                        <div class="tp-slider-nav-item d-flex align-items-center">
                           <div class="tp-slider-nav-icon">
                              <span>
                                 <img src="assets/img/slider/4/nav/icon-1.png" alt="">
                              </span>
                           </div>
                        ...
                        <div class="tp-slider-nav-item d-flex align-items-center">
                           <div class="tp-slider-nav-icon">
                              <span>
                                 <img src="assets/img/slider/4/nav/icon-2.png" alt="">
                              </span>
                           </div>
                           <div class="tp-slider-nav-content">
                        ...
                        <div class="tp-slider-nav-item d-flex align-items-center">
                           <div class="tp-slider-nav-icon">
                              <span>
                                 <img src="assets/img/slider/4/nav/icon-3.png" alt="">
                              </span>
                           </div>
                           <div class="tp-slider-nav-content">
                        ...
                        <div class="tp-slider-nav-item d-flex align-items-center">
                           <div class="tp-slider-nav-icon">
                              <span>
                                 <img src="assets/img/slider/4/nav/icon-4.png" alt="">
                              </span>
                           </div>
                           <div class="tp-slider-nav-content">
            ...
            <div class="container">
               <div class="row">
                  <div class="col-xl-6 col-lg-7">
                     <div class="row">
                        <div class="col-xl-12">
                           <div class="tp-banner-item-4 tp-banner-height-4 fix p-relative z-index-1 mb-25" data-bg-color="#F3F7FF">
                              <div class="tp-banner-thumb-4 include-bg black-bg transition-3" data-background="assets/img/banner/4/banner-1.jpg"></div>
                              <div class="tp-banner-content-4">
                                 <span>Collection</span>
                                 <h3 class="tp-banner-title-4">
                                    <a href="shop.php">Ardeco pearl <br> Rings style 2023</a>
                                 </h3>
                                 <div class="tp-banner-btn-4">
                                    <a href="shop.php" class="tp-btn tp-btn-border">
                                       Shop Now
                        ...
                        <div class="col-md-6 col-sm-6">
                           <div class="tp-banner-item-4 tp-banner-height-4 fix p-relative z-index-1 has-green sm-banner" data-bg-color="#F0F6EF">
                              <div class="tp-banner-thumb-4 include-bg black-bg transition-3" data-background="assets/img/banner/4/banner-2.jpg"></div>
                              <div class="tp-banner-content-4">
                                 <span>Trending</span>
                                 <h3 class="tp-banner-title-4">
                                    <a href="shop.php">Tropical Set</a>
                                 </h3>
                        ...
                        <div class="col-md-6 col-sm-6">
                           <div class="tp-banner-item-4 tp-banner-height-4 fix p-relative z-index-1 has-brown sm-banner" data-bg-color="#F8F1E6">
                              <div class="tp-banner-thumb-4 include-bg black-bg transition-3" data-background="assets/img/banner/4/banner-3.jpg"></div>
                              <div class="tp-banner-content-4">
                                 <span>New Arrival</span>
                                 <h3 class="tp-banner-title-4">
                                    <a href="shop.php">Gold Jewelry</a>
                                 </h3>
                  ...
                  <div class="col-xl-6 col-lg-5">
                     <div class="tp-banner-full tp-banner-full-height fix p-relative z-index-1">
                        <div class="tp-banner-full-thumb include-bg black-bg transition-3" data-background="assets/img/banner/4/banner-4.jpg"></div>
                        <div class="tp-banner-full-content">
                           <span>Collection</span>
                           <h3 class="tp-banner-full-title">
                              <a href="shop.php">Ring gold with <br> diamonds</a>
                           </h3>
                        ...
                        <div class="tp-category-slider-active-4 swiper-container mb-70">
                           <div class="swiper-wrapper">
                              <div class="tp-category-item-4 p-relative z-index-1 fix swiper-slide text-center">
                                 <div class="tp-category-thumb-4 include-bg" data-background="assets/img/category/4/category-1.jpg"></div>
                                 <!-- product action -->
                                       ...
                                       <div class="tp-category-add-to-cart">
                                          <button class="tp-category-add-to-cart-4">
                                             <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <path d="M1 5.09507C1 3.80007 1.693 3.69507 2.554 3.69507H13.446C14.307 3.69507 15 3.80007 15 5.09507C15 6.60007 14.307 6.49507 13.446 6.49507H2.554C1.693 6.49507 1 6.60007 1 5.09507Z" stroke="currentColor" stroke-width="1.5"/>
                                                ...
                                                <path d="M2.05078 6.6001L3.03778 12.6481C3.26178 14.0061 3.80078 15.0001 5.80278 15.0001H10.0238C12.2008 15.0001 12.5228 14.0481 12.7748 12.7321L13.9508 6.6001" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
                                             </svg>
                                             Add to Cart
                                          </button>
                                       </div>
                              ...
                              <div class="tp-category-item-4 p-relative z-index-1 fix swiper-slide text-center">
                                 <div class="tp-category-thumb-4 include-bg" data-background="assets/img/category/4/category-2.jpg"></div>
                                 <!-- product action -->
                                 <div class="tp-product-action-3 tp-product-action-4 tp-product-action-blackStyle tp-product-action-brownStyle">
                                    <div class="tp-product-action-item-3 d-flex flex-column">
                                       <button type="button" class="tp-product-action-btn-3 tp-product-add-cart-btn">
                                 ...
                                 <div class="tp-category-content-4">
                                    <h3 class="tp-category-title-4">
                                       <a href="product-details.php">Dôme Earrings</a>
                                    </h3>
                                    <div class="tp-category-price-wrapper-4">
                                       <span class="tp-category-price-4">$76.00</span>
                                       <div class="tp-category-add-to-cart">
                                          <button class="tp-category-add-to-cart-4">
                                             <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M5.76447 1L3.23047 3.541" stroke="currentColor" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                              ...
                              <div class="tp-category-item-4 p-relative z-index-1 fix swiper-slide text-center">
                                 <div class="tp-category-thumb-4 include-bg" data-background="assets/img/category/4/category-3.jpg"></div>
                                 <!-- product action -->
                                 <div class="tp-product-action-3 tp-product-action-4 tp-product-action-blackStyle tp-product-action-brownStyle">
                                    <div class="tp-product-action-item-3 d-flex flex-column">
                                       <button type="button" class="tp-product-action-btn-3 tp-product-add-cart-btn">
                                 ...
                                 <div class="tp-category-content-4">
                                    <h3 class="tp-category-title-4">
                                       <a href="product-details.php">Stackable Ring</a>
                                    </h3>
                                    <div class="tp-category-price-wrapper-4">
                                       <span class="tp-category-price-4">$98.00</span>
                                       <div class="tp-category-add-to-cart">
                                          <button class="tp-category-add-to-cart-4">
                                             <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M5.76447 1L3.23047 3.541" stroke="currentColor" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                              ...
                              <div class="tp-category-item-4 p-relative z-index-1 fix swiper-slide text-center">
                                 <div class="tp-category-thumb-4 include-bg" data-background="assets/img/category/4/category-4.jpg"></div>
                                 <!-- product action -->
                                 <div class="tp-product-action-3 tp-product-action-4 tp-product-action-blackStyle tp-product-action-brownStyle">
                                    <div class="tp-product-action-item-3 d-flex flex-column">
                                       <button type="button" class="tp-product-action-btn-3 tp-product-add-cart-btn">
                                 ...
                                 <div class="tp-category-content-4">
                                    <h3 class="tp-category-title-4">
                                       <a href="product-details.php">Charms & Pendants</a>
                                    </h3>
                                    <div class="tp-category-price-wrapper-4">
                                       <span class="tp-category-price-4">$120.00</span>
                                       <div class="tp-category-add-to-cart">
                                          <button class="tp-category-add-to-cart-4">
                                             <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M5.76447 1L3.23047 3.541" stroke="currentColor" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                              ...
                              <div class="tp-category-item-4 p-relative z-index-1 fix swiper-slide text-center">
                                 <div class="tp-category-thumb-4 include-bg" data-background="assets/img/category/4/category-5.jpg"></div>
                                 <!-- product action -->
                                 <div class="tp-product-action-3 tp-product-action-4 tp-product-action-blackStyle tp-product-action-brownStyle">
                                    <div class="tp-product-action-item-3 d-flex flex-column">
                                       <button type="button" class="tp-product-action-btn-3 tp-product-add-cart-btn">
                                 ...
                                 <div class="tp-category-content-4">
                                    <h3 class="tp-category-title-4">
                                       <a href="product-details.php">Nacklaces</a>
                                    </h3>
                                    <div class="tp-category-price-wrapper-4">
                                       <span class="tp-category-price-4">$72.00</span>
                                       <div class="tp-category-add-to-cart">
                                          <button class="tp-category-add-to-cart-4">
                                             <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M5.76447 1L3.23047 3.541" stroke="currentColor" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                        ...
                        <div class="tp-product-tab-inner-3 d-flex align-items-center justify-content-center justify-content-lg-end">
                           <nav>
                              <div class="nav nav-tabs justify-content-center tp-product-tab tp-tab-menu p-relative" id="nav-tab" role="tablist">
                                 <button class="nav-link active" id="nav-allCollection-tab" data-bs-toggle="tab" data-bs-target="#nav-allCollection" type="button" role="tab" aria-controls="nav-allCollection" aria-selected="true">All Collection
                                    <span class="tp-product-tab-tooltip">26</span>
                                 </button>
                                 <button class="nav-link" id="nav-shoe-tab" data-bs-toggle="tab" data-bs-target="#nav-shoe" type="button" role="tab" aria-controls="nav-shoe" aria-selected="false">Bracelets
                                 <span class="tp-product-tab-tooltip">05</span>
                                 </button>
                                 <button class="nav-link" id="nav-clothing-tab" data-bs-toggle="tab" data-bs-target="#nav-clothing" type="button" role="tab" aria-controls="nav-clothing" aria-selected="false">Necklaces
                                 <span class="tp-product-tab-tooltip">14</span>
                                 </button>
                                 <button class="nav-link" id="nav-bags-tab" data-bs-toggle="tab" data-bs-target="#nav-bags" type="button" role="tab" aria-controls="nav-bags" aria-selected="false" >Earrings
                           ...
                           <div class="row">
                              <div class="col-xl-3 col-lg-4 col-sm-6">
                                 <div class="tp-product-item-4 p-relative mb-40">
                                    <div class="tp-product-thumb-4 w-img fix">
                                       <a href="product-details.php">
                                          <img src="assets/img/product/4/product-1.jpg" alt="">
                                       </a>
                                       <!-- product action -->
                                    ...
                                    <div class="tp-product-content-4">
                                       <h3 class="tp-product-title-4">
                                          <a href="product-details.php">Marmont gold-tone ring</a>
                                       </h3>
                                       ...
                                       <div class="tp-product-price-inner-4">
                                          ...
                                          <div class="tp-product-price-add-to-cart">
                                             <button class="tp-product-add-to-cart-4">
                                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                   <path d="M5.76447 1L3.23047 3.541" stroke="currentColor" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                                   <path d="M10.2305 1L12.7645 3.541" stroke="currentColor" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                                   <path d="M1 5.09507C1 3.80007 1.693 3.69507 2.554 3.69507H13.446C14.307 3.69507 15 3.80007 15 5.09507C15 6.60007 14.307 6.49507 13.446 6.49507H2.554C1.693 6.49507 1 6.60007 1 5.09507Z" stroke="currentColor" stroke-width="1.5"/>
                              ...
                              <div class="col-xl-3 col-lg-4 col-sm-6">
                                 <div class="tp-product-item-4 p-relative mb-40">
                                    <div class="tp-product-thumb-4 w-img fix">
                                       <a href="product-details.php">
                                          <img src="assets/img/product/4/product-2.jpg" alt="">
                                       </a>
                                       <!-- product action -->
                                       <div class="tp-product-action-3 tp-product-action-4 has-shadow tp-product-action-blackStyle tp-product-action-brownStyle">
                                          <div class="tp-product-action-item-3 d-flex flex-column">
                                    ...
                                    <div class="tp-product-content-4">
                                       <h3 class="tp-product-title-4">
                                          <a href="product-details.php">Pop gold baselight</a>
                                       </h3>
                                       <div class="tp-product-info-4">
                                       ...
                                       <div class="tp-product-price-inner-4">
                                          <div class="tp-product-price-wrapper-4">
                                             <span class="tp-product-price-4">$19</span>
                                          </div>
                                          <div class="tp-product-price-add-to-cart">
                                             <button class="tp-product-add-to-cart-4">
                                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                              ...
                              <div class="col-xl-3 col-lg-4 col-sm-6">
                                 <div class="tp-product-item-4 p-relative mb-40">
                                    <div class="tp-product-thumb-4 w-img fix">
                                       <a href="product-details.php">
                                          <img src="assets/img/product/4/product-3.jpg" alt="">
                                       </a>
                                       <!-- product action -->
                                       <div class="tp-product-action-3 tp-product-action-4 has-shadow tp-product-action-blackStyle tp-product-action-brownStyle">
                                          <div class="tp-product-action-item-3 d-flex flex-column">
                                    ...
                                    <div class="tp-product-content-4">
                                       <h3 class="tp-product-title-4">
                                          <a href="product-details.php">Diamond vintage ring</a>
                                       </h3>
                                       <div class="tp-product-info-4">
                                          <p>14k yellow gold</p>
                                       </div>
                                       <div class="tp-product-price-inner-4">
                                          <div class="tp-product-price-wrapper-4">
                                             <span class="tp-product-price-4">$23</span>
                                          </div>
                                          <div class="tp-product-price-add-to-cart">
                                             <button class="tp-product-add-to-cart-4">
                                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                              ...
                              <div class="col-xl-3 col-lg-4 col-sm-6">
                                 <div class="tp-product-item-4 p-relative mb-40">
                                    <div class="tp-product-thumb-4 w-img fix">
                                       <a href="product-details.php">
                                          <img src="assets/img/product/4/product-4.jpg" alt="">
                                       </a>
                                    ...
                                    <div class="tp-product-content-4">
                                       <h3 class="tp-product-title-4">
                                          <a href="product-details.php">Amber earrings close-up</a>
                                       </h3>
                                       <div class="tp-product-info-4">
                                       ...
                                       <div class="tp-product-price-inner-4">
                                          <div class="tp-product-price-wrapper-4">
                                             <span class="tp-product-price-4">$98</span>
                                          </div>
                                          <div class="tp-product-price-add-to-cart">
                                             <button class="tp-product-add-to-cart-4">
                                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                              ...
                              <div class="col-xl-3 col-lg-4 col-sm-6">
                                 <div class="tp-product-item-4 p-relative mb-40">
                                    <div class="tp-product-thumb-4 w-img fix">
                                       <a href="product-details.php">
                                          <img src="assets/img/product/4/product-5.jpg" alt="">
                                       </a>
                                    ...
                                    <div class="tp-product-content-4">
                                       <h3 class="tp-product-title-4">
                                          <a href="product-details.php">Gold malachite earrings</a>
                                       </h3>
                                       <div class="tp-product-info-4">
                                          <p>Sterling silver erring</p>
                                       </div>
                                       ...
                                       <div class="tp-product-price-inner-4">
                                          <div class="tp-product-price-wrapper-4">
                                             <span class="tp-product-price-4 new-price">$19.00</span>
                                          <span class="tp-product-price-4 old-price">$28.00</span>
                                          </div>
                                          <div class="tp-product-price-add-to-cart">
                                             <button class="tp-product-add-to-cart-4">
                                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                              ...
                              <div class="col-xl-3 col-lg-4 col-sm-6">
                                 <div class="tp-product-item-4 p-relative mb-40">
                                    <div class="tp-product-thumb-4 w-img fix">
                                       <a href="product-details.php">
                                          <img src="assets/img/product/4/product-6.jpg" alt="">
                                       </a>
                                    ...
                                    <div class="tp-product-content-4">
                                       <h3 class="tp-product-title-4">
                                          <a href="product-details.php">Gold jewellery baselight</a>
                                       </h3>
                                       <div class="tp-product-info-4">
                                          <p>14k yellow gold</p>
                                       </div>
                                       <div class="tp-product-price-wrapper-4">
                                          <div class="tp-product-price-inner-4">
                                             <div class="tp-product-price-wrapper-4">
                                                <span class="tp-product-price-4">$40.00</span>
                                             </div>
                                             <div class="tp-product-price-add-to-cart">
                                                <button class="tp-product-add-to-cart-4">
                                                   <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                              ...
                              <div class="col-xl-3 col-lg-4 col-sm-6">
                                 <div class="tp-product-item-4 p-relative mb-40">
                                    <div class="tp-product-thumb-4 w-img fix">
                                       <a href="product-details.php">
                                          <img src="assets/img/product/4/product-7.jpg" alt="">
                                       </a>
                                    ...
                                    <div class="tp-product-content-4">
                                       <h3 class="tp-product-title-4">
                                          <a href="product-details.php">Prong diamond ring</a>
                                       </h3>
                                       <div class="tp-product-info-4">
                                          <p>Gold vermeil, pearl</p>
                                       </div>
                                       <div class="tp-product-price-inner-4">
                                          <div class="tp-product-price-wrapper-4">
                                             <span class="tp-product-price-4 new-price">$104.00</span>
                                          </div>
                                          <div class="tp-product-price-add-to-cart">
                                             <button class="tp-product-add-to-cart-4">
                                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                              ...
                              <div class="col-xl-3 col-lg-4 col-sm-6">
                                 <div class="tp-product-item-4 p-relative mb-40">
                                    <div class="tp-product-thumb-4 w-img fix">
                                       <a href="product-details.php">
                                          <img src="assets/img/product/4/product-8.jpg" alt="">
                                       </a>
                                    ...
                                    <div class="tp-product-content-4">
                                       <h3 class="tp-product-title-4">
                                          <a href="product-details.php">Malachite earrings</a>
                                       </h3>
                                       <div class="tp-product-info-4">
                                          <p>14k yellow gold</p>
                                       </div>
                                       <div class="tp-product-price-inner-4">
                                          <div class="tp-product-price-wrapper-4">
                                             <span class="tp-product-price-4 new-price">$110.00</span>
                                          <span class="tp-product-price-4 old-price">$119.00</span>
                                          </div>
                                          <div class="tp-product-price-add-to-cart">
                                             <button class="tp-product-add-to-cart-4">
                                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                              ...
                              <div class="col-xl-3 col-lg-4 col-sm-6">
                                 <div class="tp-product-item-4 p-relative mb-40">
                                    ...
                                    <div class="tp-product-content-4">
                                       ...
                                       <div class="tp-product-price-wrapper-4">
                                          <span class="tp-product-price-4">$54.00</span>
                                       </div>
                                    </div>
                                 </div>
                              </div>
                              <div class="col-xl-3 col-lg-4 col-sm-6">
                                 <div class="tp-product-item-4 p-relative mb-40">
                                    ...
                                    <div class="tp-product-content-4">
                                       ...
                                       <div class="tp-product-price-wrapper-4">
                                          <span class="tp-product-price-4">$102.00</span>
                                       </div>
                                    </div>
                                 </div>
                              </div>
                              <div class="col-xl-3 col-lg-4 col-sm-6">
                                 <div class="tp-product-item-4 p-relative mb-40">
                                    ...
                                    <div class="tp-product-content-4">
                                       ...
                                       <div class="tp-product-price-wrapper-4">
                                          <span class="tp-product-price-4 new-price">$123.00</span>
                                          <span class="tp-product-price-4 old-price">$126.00</span>
                                       </div>
                                    </div>
                                 </div>
                              </div>
         ...
         <section class="tp-collection-area">
            <div class="container-fluid">
               <div class="tp-collection-inner-4 pl-100 pr-100">
                  <div class="row gx-0">
                     <div class="col-xl-6 col-lg-6">
                        <div class="tp-collection-thumb-wrapper-4 p-relative fix z-index-1" >
                           <div class="tp-collection-thumb-4 include-bg black-bg" data-background="assets/img/product/collection/4/collection-1.jpg"></div>
                           <span class="tp-collection-thumb-info-4">WITH NEW LOOK & NEW COLLECTION</span>

                           <div class="tp-collection-hotspot-item tp-collection-hotspot-1">
                              <span class="tp-hotspot tp-pulse-border ">
                                 <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M7 1V13" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                              ...
                              <div class="tp-collection-hotspot-content">
                                 <h3 class="tp-collection-hotspot-title">Skincare Product</h3>
                                 <p>Lorem ipsum dolor sit amet consectetur.</p>
                              </div>
                           </div>

                           <div class="tp-collection-hotspot-item tp-collection-hotspot-2">
                              <span class="tp-hotspot tp-pulse-border ">
                                 <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M7 1V13" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                    <path d="M1 7H13" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                              ...
                              <div class="tp-collection-hotspot-content on-top">
                                 <h3 class="tp-collection-hotspot-title">Skincare Product</h3>
                                 <p>Lorem ipsum dolor sit amet consectetur.</p>
                              </div>
                           </div>
                     ...
                     <div class="col-xl-6 col-lg-6">
                        <div class="tp-collection-wrapper-4 p-relative pt-90 pb-95" data-bg-color="#F6F6F6">
                           <span class="tp-collection-side-text">
                              <img src="assets/img/product/collection/4/side-text.png" alt="">
                           </span>
                              ...
                              <div class="col-xl-6 col-lg-8">
                                 <div class="tp-collection-item-4 text-center">
                                    ...
                                    <div class="tp-collection-thumb-banner-4 m-img">
                                       <a href="shop.php">
                                          <img src="assets/img/product/collection/4/collection-sm-1.jpg" alt="">
                                       </a>
                                    </div>
                                    <div class="tp-collection-content-4">
                                       <h3 class="tp-collection-title-4">
                                          <a href="shop.php">Our finest jewelry</a>
                                       </h3>
                                       <div class="tp-collection-btn-4">
                                          <a href="shop.php" class="tp-link-btn-line-2">
                           ...
                           <div class="swiper-wrapper">
                              <div class="tp-best-item-4 swiper-slide">
                                 <div class="tp-product-item-4 p-relative mb-40">
                                    <div class="tp-product-thumb-4 w-img fix">
                                       <a href="product-details.php">
                                          <img src="assets/img/product/4/product-9.jpg" alt="">
                                       </a>
                                       <!-- product action -->
                                       <div class="tp-product-action-3 tp-product-action-4 has-shadow tp-product-action-blackStyle tp-product-action-brownStyle">
                                          <div class="tp-product-action-item-3 d-flex flex-column">
                                    ...
                                    <div class="tp-product-content-4">
                                       ...
                                       <div class="tp-best-price">
                                          ...
                                          <div class="tp-best-add-to-cart">
                                             <button class="tp-best-add-to-cart-btn">
                                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                   <path d="M5.76447 1L3.23047 3.541" stroke="currentColor" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                                   <path d="M10.2305 1L12.7645 3.541" stroke="currentColor" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                                   <path d="M1 5.09507C1 3.80007 1.693 3.69507 2.554 3.69507H13.446C14.307 3.69507 15 3.80007 15 5.09507C15 6.60007 14.307 6.49507 13.446 6.49507H2.554C1.693 6.49507 1 6.60007 1 5.09507Z" stroke="currentColor" stroke-width="1.5"/>
                              ...
                              <div class="tp-best-item-4 swiper-slide">
                                 <div class="tp-product-item-4 p-relative mb-40">
                                    <div class="tp-product-thumb-4 w-img fix">
                                       <a href="product-details.php">
                                          <img src="assets/img/product/4/product-10.jpg" alt="">
                                       </a>
                                       <!-- product action -->
                                       <div class="tp-product-action-3 tp-product-action-4 has-shadow tp-product-action-blackStyle tp-product-action-brownStyle">
                                          <div class="tp-product-action-item-3 d-flex flex-column">
                                    ...
                                    <div class="tp-product-content-4">
                                       <h3 class="tp-product-title-4">
                                          <a href="product-details.php">Diamond vintage earrings</a>
                                       </h3>
                                       <div class="tp-product-info-4">
                                          <p>14k yellow gold</p>
                                       </div>
                                       <div class="tp-best-price">
                                          <div class="tp-product-price-wrapper-4">
                                             <span class="tp-product-price-4">$14</span>
                                          </div>
                                          <div class="tp-best-add-to-cart">
                                             <button class="tp-best-add-to-cart-btn">
                                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                              ...
                              <div class="tp-best-item-4 swiper-slide">
                                 <div class="tp-product-item-4 p-relative mb-40">
                                    <div class="tp-product-thumb-4 w-img fix">
                                       <a href="product-details.php">
                                          <img src="assets/img/product/4/product-11.jpg" alt="">
                                       </a>
                                       <!-- product action -->
                                       <div class="tp-product-action-3 tp-product-action-4 has-shadow tp-product-action-blackStyle tp-product-action-brownStyle">
                                          <div class="tp-product-action-item-3 d-flex flex-column">
                                    ...
                                    <div class="tp-product-content-4">
                                       <h3 class="tp-product-title-4">
                                          <a href="product-details.php">Gold ring with diamonds</a>
                                       </h3>
                                       <div class="tp-product-info-4">
                                          <p>Gold vermeil, pearl</p>
                                       </div>
                              ...
                              <div class="tp-best-item-4 swiper-slide">
                                 <div class="tp-product-item-4 p-relative mb-40">
                                    <div class="tp-product-thumb-4 w-img fix">
                                       <a href="product-details.php">
                                          <img src="assets/img/product/4/product-12.jpg" alt="">
                                       </a>
                                       <!-- product action -->
                                       <div class="tp-product-action-3 tp-product-action-4 has-shadow tp-product-action-blackStyle tp-product-action-brownStyle">
                                          <div class="tp-product-action-item-3 d-flex flex-column">
                                    ...
                                    <div class="tp-product-content-4">
                                       ...
                                       <div class="tp-best-price">
                                          <div class="tp-product-price-wrapper-4">
                                             <span class="tp-product-price-4">$87</span>
                                          </div>
                                          <div class="tp-best-add-to-cart">
                                             <button class="tp-best-add-to-cart-btn">
                                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                              ...
                              <div class="tp-best-item-4 swiper-slide">
                                 <div class="tp-product-item-4 p-relative mb-40">
                                    ...
                                    <div class="tp-product-content-4">
                                       <h3 class="tp-product-title-4">
                                          <a href="product-details.php">Diamond Plateted Ring</a>
                                       </h3>
                                       <div class="tp-product-info-4">
                                          <p>Gold vermeil, white topaz</p>
                                       </div>
                                       <div class="tp-best-price">
                                          <div class="tp-product-price-wrapper-4">
                                             <span class="tp-product-price-4">$59</span>
                                          </div>
                                          <div class="tp-best-add-to-cart">
                                             <button class="tp-best-add-to-cart-btn">
                                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
         ...
         <section class="tp-instagram-area tp-instagram-style-4 pt-110 pb-10">
            <div class="container-fluid pl-20 pr-20">
               <div class="row">
                  <div class="col-xl-12">
                     <div class="tp-section-title-wrapper-4 mb-50 text-center">
                        <h3 class="tp-section-title-4">Trends on image feed</h3>
               ...
               <div class="row row-cols-lg-6 row-cols-sm-2 row-cols-1 gx-2 gy-2 gy-lg-0">
                  <div class="col">
                     <div class="tp-instagram-item-2 w-img">
                        <img src="assets/img/instagram/4/instagram-1.jpg" alt="">
                        <div class="tp-instagram-icon-2">
                           <a href="assets/img/instagram/4/instagram-1.jpg" class="popup-image"><i class="fa-brands fa-instagram"></i></a>
                        </div>
                     </div>
                  </div>
                  <div class="col">
                     <div class="tp-instagram-item-2 w-img">
                        <img src="assets/img/instagram/4/instagram-2.jpg" alt="">
                        <div class="tp-instagram-icon-2">
                           <a href="assets/img/instagram/4/instagram-2.jpg" class="popup-image"><i class="fa-brands fa-instagram"></i></a>
                        </div>
                     </div>
                  </div>
                  <div class="col">
                     <div class="tp-instagram-item-2 w-img">
                        <img src="assets/img/instagram/4/instagram-3.jpg" alt="">
                        <div class="tp-instagram-icon-2">
                           <a href="assets/img/instagram/4/instagram-3.jpg" class="popup-image"><i class="fa-brands fa-instagram"></i></a>
                        </div>
                     </div>
                  </div>
                  <div class="col">
                     <div class="tp-instagram-item-2 w-img">
                        <img src="assets/img/instagram/4/instagram-4.jpg" alt="">
                        <div class="tp-instagram-icon-2">
                           <a href="assets/img/instagram/4/instagram-4.jpg" class="popup-image"><i class="fa-brands fa-instagram"></i></a>
                        </div>
                     </div>
                  </div>
                  <div class="col">
                     <div class="tp-instagram-item-2 w-img">
                        <img src="assets/img/instagram/4/instagram-5.jpg" alt="">
                        <div class="tp-instagram-icon-2">
                           <a href="assets/img/instagram/4/instagram-5.jpg" class="popup-image"><i class="fa-brands fa-instagram"></i></a>
                        </div>
                     </div>
                  </div>
                  <div class="col">
                     <div class="tp-instagram-item-2 w-img">
                        <img src="assets/img/instagram/4/instagram-6.jpg" alt="">
                        <div class="tp-instagram-icon-2">
                           <a href="assets/img/instagram/4/instagram-6.jpg" class="popup-image"><i class="fa-brands fa-instagram"></i></a>
                        </div>
                     </div>
                  </div>
               </div>
...
<!-- Mirrored from.php.weblearnbd.net/shofy-prv/shofy/index-4.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Oct 2023 08:17:47 GMT -->
<.php>
