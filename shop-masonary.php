...
<!-- Mirrored from html.weblearnbd.net/shofy-prv/shofy/shop-masonary.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Oct 2023 08:18:46 GMT -->
<head>
      <meta charset="utf-8">
   ...
   <body>
     ...
     <!-- cart mini area end -->
                     ...
                     <div class="tp-shop-widget-product">
                        <div class="tp-shop-widget-product-item d-flex align-items-center">
                           ...
                           <div class="tp-shop-widget-product-content">
                              ...
                              <h4 class="tp-shop-widget-product-title">
                                 <a href="product-details.php">Smart watches wood...</a>
                              </h4>
                        ...
                        <div class="tp-shop-widget-product-item d-flex align-items-center">
                           ...
                           <div class="tp-shop-widget-product-content">
                              ...
                              <h4 class="tp-shop-widget-product-title">
                                 <a href="product-details.php">Decoration for panda.</a>
                              </h4>
                              <div class="tp-shop-widget-product-price-wrapper">
                        ...
                        <div class="tp-shop-widget-product-item d-flex align-items-center">
                           ...
                           <div class="tp-shop-widget-product-content">
                              ...
                              <h4 class="tp-shop-widget-product-title">
                                 <a href="product-details.php">Trending Watch for Man</a>
                              </h4>
                              <div class="tp-shop-widget-product-price-wrapper">
                        ...
                        <div class="tp-shop-widget-product-item d-flex align-items-center">
                           ...
                           <div class="tp-shop-widget-product-content">
                              ...
                              <h4 class="tp-shop-widget-product-title">
                                 <a href="product-details.php">Minimal Backpack.</a>
                              </h4>
                              <div class="tp-shop-widget-product-price-wrapper">
      ...
      <main>
               ...
               <div class="row">
                  <div class="col-xxl-12">
                     <div class="breadcrumb__content p-relative z-index-1">
                        <h3 class="breadcrumb__title">Shop Masonary</h3>
                        <div class="breadcrumb__list">
                           <span><a href="#">Home</a></span>
                           <span>Shop Masonary</span>
                        </div>
                     </div>
                  </div>
               </div>
         ...
         <!-- shop area start -->
         <section class="tp-shop-area pb-120 tp-shop-masonary">
            <div class="container">
               <div class="row">
                  <div class="col-xl-12">
                        ...
                        <div class="tp-shop-items-wrapper tp-shop-item-primary">
                           <div class="tab-content" id="productTabContent">
                              <div class="tab-pane fade show active" id="grid-tab-pane" role="tabpanel" aria-labelledby="grid-tab" tabindex="0">
                                 <div class="row grid">
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 grid-item">
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 grid-item">
                                       <div class="tp-product-item-2 mb-40">
                                          <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                             <a href="product-details.php">
                                                <img src="assets/img/product/masonary/masonary-1.jpg" alt="">
                                             </a>
                                             <!-- product action -->
                                             <div class="tp-product-action-2 tp-product-action-blackStyle">
                                                <div class="tp-product-action-item-2 d-flex flex-column">
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 grid-item">
                                       <div class="tp-product-item-2 mb-40">
                                          <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                             <a href="product-details.php">
                                                <img src="assets/img/product/masonary/masonary-2.jpg" alt="">
                                             </a>
                                             <!-- product action -->
                                             <div class="tp-product-action-2 tp-product-action-blackStyle">
                                                <div class="tp-product-action-item-2 d-flex flex-column">
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-sm-6 grid-item">
                                       <div class="tp-product-item-2 mb-40">
                                          <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                             <a href="product-details.php">
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-sm-6 grid-item">
                                       <div class="tp-product-item-2 mb-40">
                                          ...
                                          <div class="tp-product-content-2 pt-15">
                                             ...
                                             <h3 class="tp-product-title-2">
                                                <a href="product-details.php">Full Sleeve Shirt(Pink)</a>
                                             </h3>
                                             <div class="tp-product-rating-icon tp-product-rating-icon-2">
                                                <span><i class="fa-solid fa-star"></i></span>
                                                <span><i class="fa-solid fa-star"></i></span>
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-sm-6 grid-item">
                                       <div class="tp-product-item-2 mb-40">
                                          <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                             <a href="product-details.php">
                                                <img src="assets/img/product/2/prodcut-13.jpg" alt="">
                                             </a>
                                             <!-- product action -->
                                             <div class="tp-product-action-2 tp-product-action-blackStyle">
                                                <div class="tp-product-action-item-2 d-flex flex-column">
                                          ...
                                          <div class="tp-product-content-2 pt-15">
                                             ...
                                             <h3 class="tp-product-title-2">
                                                <a href="product-details.php">Blue Dress For Women</a>
                                             </h3>
                                             <div class="tp-product-rating-icon tp-product-rating-icon-2">
                                                <span><i class="fa-solid fa-star"></i></span>
                                                <span><i class="fa-solid fa-star"></i></span>
                                             ...
                                             <div class="tp-product-price-wrapper-2">
                                                <span class="tp-product-price-2">$56.00</span>
                                             </div>
                                          </div>
                                       </div>
                                    </div>
                                    <div class="col-xl-3 col-lg-3 col-sm-6 grid-item">
                                       <div class="tp-product-item-2 mb-40">
                                          <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                             <a href="product-details.php">
                                                <img src="assets/img/product/2/prodcut-15.jpg" alt="">
                                             </a>
                                             <!-- product action -->
                                             <div class="tp-product-action-2 tp-product-action-blackStyle">
                                                <div class="tp-product-action-item-2 d-flex flex-column">
                                          ...
                                          <div class="tp-product-content-2 pt-15">
                                             ...
                                             <h3 class="tp-product-title-2">
                                                <a href="product-details.php">Demin with top Jaden</a>
                                             </h3>
                                             <div class="tp-product-rating-icon tp-product-rating-icon-2">
                                                <span><i class="fa-solid fa-star"></i></span>
                                                <span><i class="fa-solid fa-star"></i></span>
                                             ...
                                             <div class="tp-product-price-wrapper-2">
                                                <span class="tp-product-price-2 new-price">$36.00</span>
                                                <span class="tp-product-price-2 old-price">$42.00</span>
                                             </div>
                                          </div>
                                       </div>
                                    </div>
                                    <div class="col-xl-3 col-lg-3 col-sm-6 grid-item">
                                       <div class="tp-product-item-2 mb-40">
                                          <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                             <a href="product-details.php">
                                                <img src="assets/img/product/2/prodcut-14.jpg" alt="">
                                             </a>
                                             <!-- product action -->
                                             <div class="tp-product-action-2 tp-product-action-blackStyle">
                                                <div class="tp-product-action-item-2 d-flex flex-column">
                                          ...
                                          <div class="tp-product-content-2 pt-15">
                                             ...
                                             <h3 class="tp-product-title-2">
                                                <a href="product-details.php">Night Dress Golden</a>
                                             </h3>
                                             <div class="tp-product-rating-icon tp-product-rating-icon-2">
                                                <span><i class="fa-solid fa-star"></i></span>
                                                <span><i class="fa-solid fa-star"></i></span>
                                             ...
                                             <div class="tp-product-price-wrapper-2">
                                                <span class="tp-product-price-2">$60.00</span>
                                             </div>
                                          </div>
                                       </div>
                                    </div>
                                          ...
                                          <div class="tp-product-list-item d-md-flex">
                                             ...
                                             <div class="tp-product-list-content">
                                                <div class="tp-product-content-2 pt-15">
                                                   ...
                                                   <h3 class="tp-product-title-2">
                                                      <a href="product-details.php">Black Leather Bag</a>
                                                   </h3>
                                                   <div class="tp-product-rating-icon tp-product-rating-icon-2">
                                                      <span><i class="fa-solid fa-star"></i></span>
                                                      <span><i class="fa-solid fa-star"></i></span>
                                          ...
                                          <div class="tp-product-list-item d-md-flex">
                                             ...
                                             <div class="tp-product-list-content">
                                                <div class="tp-product-content-2 pt-15">
                                                   ...
                                                   <h3 class="tp-product-title-2">
                                                      <a href="product-details.php">Winter Men's Jacket</a>
                                                   </h3>
                                                   <div class="tp-product-rating-icon tp-product-rating-icon-2">
                                                      <span><i class="fa-solid fa-star"></i></span>
                                                      <span><i class="fa-solid fa-star"></i></span>
                                          ...
                                          <div class="tp-product-list-item d-md-flex">
                                             ...
                                             <div class="tp-product-list-content">
                                                <div class="tp-product-content-2 pt-15">
                                                   ...
                                                   <h3 class="tp-product-title-2">
                                                      <a href="product-details.php">Full Sleeve Shirt For Men</a>
                                                   </h3>
                                                   <div class="tp-product-rating-icon tp-product-rating-icon-2">
                                                      <span><i class="fa-solid fa-star"></i></span>
                                                      <span><i class="fa-solid fa-star"></i></span>
                        ...
                        <div class="tp-shop-pagination mt-20">
                           <div class="tp-pagination">
                              <nav>
                                 <ul>
                                    <li>
                                       <a href="shop.php" class="tp-pagination-prev prev page-numbers">
...
<!-- Mirrored from html.weblearnbd.net/shofy-prv/shofy/shop-masonary.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Oct 2023 08:18:51 GMT -->
</html>
