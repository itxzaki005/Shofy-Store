...
<!-- Mirrored from html.weblearnbd.net/shofy-prv/shofy/index-3.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Oct 2023 08:16:22 GMT -->
<head>
      <meta charset="utf-8">
   ...
   <body>
                 ...
                 <div class="cartmini__widget">
                     <div class="cartmini__widget-item">
                         ...
                         <div class="cartmini__content">
                           <h5 class="cartmini__title"><a href="product-details-progress.php">Level Bolt Smart Lock</a></h5>
     ...
     <!-- cart mini area end -->
      ...
      <main>
            ...
            <div class="tp-slider-active-3 swiper-container">
               <div class="swiper-wrapper">
                  <div class="tp-slider-item-3 tp-slider-height-3 p-relative swiper-slide black-bg d-flex align-items-center" >
                     <div class="tp-slider-thumb-3 include-bg" data-background="assets/img/slider/3/slider-1.jpg"></div>
                     <div class="container">
                        <div class="row align-items-center">
                           <div class="col-xl-6 col-lg-6 col-md-8">
                              <div class="tp-slider-content-3">
                                 <span>Winter Collection 2023</span>
                                 <h3 class="tp-slider-title-3">Be your kind of beauty</h3>
                                 <div class="tp-slider-feature-3 d-flex flex-wrap align-items-center p-relative z-index-1 mb-15">
                                    <div class="tp-slider-feature-item-3 d-flex mb-30">
                                       ...
                                       <div class="tp-slider-feature-content-3">
                                          <h3 class="tp-slider-feature-title-3">High-end <br> Cosmetics</h3>
                                       </div>
                                    </div>
                                    <div class="tp-slider-feature-item-3 d-flex mb-30">
                                       <div class="tp-slider-feature-icon-3">
                                       ...
                                       <div class="tp-slider-feature-content-3">
                                          <h3 class="tp-slider-feature-title-3">Vegan <br> Product</h3>
                                       </div>
                                    </div>
                                    <div class="tp-slider-feature-item-3 d-flex mb-30">
                                       <div class="tp-slider-feature-icon-3">
                                       ...
                                       <div class="tp-slider-feature-content-3">
                                          <h3 class="tp-slider-feature-title-3">Express <br> Make-up</h3>
                                       </div>
                                    </div>
                                 </div>
                  ...
                  <div class="tp-slider-item-3 tp-slider-height-3 p-relative swiper-slide black-bg d-flex align-items-center" >
                     <div class="tp-slider-thumb-3 include-bg" data-background="assets/img/slider/3/slider-2.jpg"></div>
                     <div class="container">
                        <div class="row align-items-center">
                           <div class="col-xl-6 col-lg-6 col-md-8">
                              <div class="tp-slider-content-3">
                                 <span>Top Brand Collection</span>
                                 <h3 class="tp-slider-title-3">Use the best for you.</h3>
                                 <div class="tp-slider-feature-3 d-flex flex-wrap align-items-center p-relative z-index-1 mb-15">
                                    <div class="tp-slider-feature-item-3 d-flex mb-30">
                                       <div class="tp-slider-feature-icon-3">
                                          <span>
                  ...
                  <div class="tp-slider-item-3 tp-slider-height-3 p-relative swiper-slide black-bg d-flex align-items-center" >
                     <div class="tp-slider-thumb-3 include-bg" data-background="assets/img/slider/3/slider-3.jpg"></div>
                     <div class="container">
                        <div class="row align-items-center">
                           <div class="col-xl-6 col-lg-6 col-md-8">
                              <div class="tp-slider-content-3">
                                 <span>Awesome Beauty Products</span>
                                 <h3 class="tp-slider-title-3">Don't Worry for Skincare</h3>
                                 <div class="tp-slider-feature-3 d-flex flex-wrap align-items-center p-relative z-index-1 mb-15">
                                    <div class="tp-slider-feature-item-3 d-flex mb-30">
                                       <div class="tp-slider-feature-icon-3">
                                          <span>
               ...
               <div class="row align-items-end">
                  ...
                  <div class="col-lg-6 col-md-4">
                     <div class="tp-category-more-3 text-md-end mb-55">
                        <a href="shop-category.php" class="tp-btn">
                           Shop All Products 
               ...
               <div class="row">
                  <div class="col-lg-3 col-sm-6">
                     <div class="tp-category-item-3 p-relative black-bg text-center z-index-1 fix mb-30">
                        <div class="tp-category-thumb-3 include-bg" data-background="assets/img/category/3/category-1.jpg"></div>
                        <div class="tp-category-content-3 transition-3">
                           <h3 class="tp-category-title-3">
                              <a href="shop-category.php">Discover Skincare</a>
                           </h3>
                           <span class="tp-categroy-ammount-3">23 Products</span>
                           <div class="tp-category-btn-3">
                              <a href="shop-category.php" class="tp-link-btn tp-link-btn-2">
                                 View Now 
                  ...
                  <div class="col-lg-3 col-sm-6">
                     <div class="tp-category-item-3 p-relative black-bg text-center z-index-1 fix mb-30">
                        <div class="tp-category-thumb-3 include-bg" data-background="assets/img/category/3/category-2.jpg"></div>
                        <div class="tp-category-content-3 transition-3">
                           <h3 class="tp-category-title-3">
                              <a href="shop-category.php">Beauty of Skin</a>
                           </h3>
                           <span class="tp-categroy-ammount-3">16 Products</span>
                           <div class="tp-category-btn-3">
                              <a href="shop-category.php" class="tp-link-btn tp-link-btn-2">
                                 View Now 
                                 <svg width="7" height="12" viewBox="0 0 7 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div class="col-lg-3 col-sm-6">
                     <div class="tp-category-item-3 p-relative black-bg text-center z-index-1 fix mb-30">
                        <div class="tp-category-thumb-3 include-bg" data-background="assets/img/category/3/category-3.jpg"></div>
                        <div class="tp-category-content-3 transition-3">
                           <h3 class="tp-category-title-3">
                              <a href="shop-category.php">Awesome Lip Care</a>
                           </h3>
                           <span class="tp-categroy-ammount-3">05 Products</span>
                           <div class="tp-category-btn-3">
                              <a href="shop-category.php" class="tp-link-btn tp-link-btn-2">
                                 View Now 
                                 <svg width="7" height="12" viewBox="0 0 7 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div class="col-lg-3 col-sm-6">
                     <div class="tp-category-item-3 p-relative black-bg text-center z-index-1 fix mb-30">
                        <div class="tp-category-thumb-3 include-bg" data-background="assets/img/category/3/category-4.jpg"></div>
                        <div class="tp-category-content-3 transition-3">
                           <h3 class="tp-category-title-3">
                              <a href="shop-category.php">Facial Care</a>
                           </h3>
                           <span class="tp-categroy-ammount-3">14 Products</span>
                           <div class="tp-category-btn-3">
                              <a href="shop-category.php" class="tp-link-btn tp-link-btn-2">
                                 View Now 
                                 <svg width="7" height="12" viewBox="0 0 7 12" fill="none" xmlns="http://www.w3.org/2000/svg">
         ...
         <!-- featured area start -->
         <section class="tp-featured-product-area pt-70 pb-150">
            <div class="container">
               <div class="row gx-0">
                  <div class="col-lg-4 col-md-6">
                     <div class="tp-featured-item-3 text-center">
                        <div class="tp-featured-thumb-3 d-flex align-items-end justify-content-center">
                           <img src="assets/img/product/featured/featured-1.png" alt="">
                        </div>
                        <div class="tp-featured-content-3">
                           <h3 class="tp-featured-title-3">
                              <a href="product-details-progress.php">Matte Liquid <br> Lipstick & Lip Liner</a>
                           </h3>
                           <p>Molestias internos et commodi tempora dolores sapiente sed iste.</p>
                  ...
                  <div class="col-lg-4 col-md-6">
                     <div class="tp-featured-item-3 text-center">
                        <div class="tp-featured-thumb-3 d-flex align-items-end justify-content-center">
                           <img src="assets/img/product/featured/featured-2.png" alt="">
                        </div>
                        <div class="tp-featured-content-3">
                           <h3 class="tp-featured-title-3">
                              <a href="product-details-progress.php">Crushed Liquid <br> Lip  - Cherry Crush</a>
                           </h3>
                           <p>Molestias internos et commodi tempora dolores sapiente sed iste.</p>
                           <div class="tp-featured-price-3">
                              <span>Save $98</span>
                  ...
                  <div class="col-lg-4 col-md-6">
                     <div class="tp-featured-item-3 text-center">
                        <div class="tp-featured-thumb-3 has-translate d-flex align-items-end justify-content-center">
                           <img src="assets/img/product/featured/featured-3.png" alt="">
                        </div>
                        <div class="tp-featured-content-3">
                           <h3 class="tp-featured-title-3">
                              <a href="product-details-progress.php">Mega Waterproof <br> Concealer  - 125 Bisque</a>
                           </h3>
                           <p>Molestias internos et commodi tempora dolores sapiente sed iste.</p>
                           <div class="tp-featured-price-3">
                              <span>Save $133</span>
               ...
               <div class="row">
                  <div class="col-lg-3 col-md-4 col-sm-6">
                     <div class="tp-product-item-3 mb-50">
                        <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                           <a href="product-details-progress.php">
                              <img src="assets/img/product/3/product-1.jpg" alt="">
                           </a>
                        ...
                        <div class="tp-product-content-3">
                           ...
                           <h3 class="tp-product-title-3">
                              <a href="product-details-progress.php">Face Wash by Olay Regenerist</a>
                           </h3>
                  ...
                  <div class="col-lg-3 col-md-4 col-sm-6">
                     <div class="tp-product-item-3 mb-50">
                        <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                           <a href="product-details-progress.php">
                              <img src="assets/img/product/3/product-2.jpg" alt="">
                           </a>
                        ...
                        <div class="tp-product-content-3">
                           ...
                           <h3 class="tp-product-title-3">
                              <a href="product-details-progress.php">Kabuki Makeup Brush</a>
                           </h3>
                           <div class="tp-product-price-wrapper-3">
                              <span class="tp-product-price-3 new-price">$62.00</span>
                              <span class="tp-product-price-3 old-price">$72.00</span>
                           </div>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-3 col-md-4 col-sm-6">
                     <div class="tp-product-item-3 mb-50">
                        <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                           <a href="product-details-progress.php">
                              <img src="assets/img/product/3/product-3.jpg" alt="">
                           </a>
                        ...
                        <div class="tp-product-content-3">
                           ...
                           <h3 class="tp-product-title-3">
                              <a href="product-details-progress.php">Organic Face Sunscreen</a>
                           </h3>
                           <div class="tp-product-price-wrapper-3">
                  ...
                  <div class="col-lg-3 col-md-4 col-sm-6">
                     <div class="tp-product-item-3 mb-50">
                        <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                           <a href="product-details-progress.php">
                              <img src="assets/img/product/3/product-4.jpg" alt="">
                           </a>
                        ...
                        <div class="tp-product-content-3">
                           ...
                           <h3 class="tp-product-title-3">
                              <a href="product-details-progress.php">Pure Cosmetics Lip Gloss</a>
                           </h3>
                           <div class="tp-product-price-wrapper-3">
                              <span class="tp-product-price-3 new-price">$23.00</span>
                              <span class="tp-product-price-3 old-price">$25.00</span>
                           </div>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-3 col-md-4 col-sm-6">
                     <div class="tp-product-item-3 mb-50">
                        <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                           <a href="product-details-progress.php">
                              <img src="assets/img/product/3/product-5.jpg" alt="">
                           </a>
                        ...
                        <div class="tp-product-content-3">
                           ...
                           <div class="tp-product-price-wrapper-3">
                              <span class="tp-product-price-3 new-price">$16.00</span>
                              <span class="tp-product-price-3 old-price">$22.00</span>
                           </div>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-3 col-md-4 col-sm-6">
                     <div class="tp-product-item-3 mb-50">
                        <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                           <a href="product-details-progress.php">
                              <img src="assets/img/product/3/product-6.jpg" alt="">
                           </a>
                        ...
                        <div class="tp-product-content-3">
                           <div class="tp-product-tag-3">
                              <span>Night Face</span>
                           </div>
                           <h3 class="tp-product-title-3">
                              <a href="product-details-progress.php">Retinol Value Set Duo</a>
                           </h3>
                           <div class="tp-product-price-wrapper-3">
                              <span class="tp-product-price-3">$76.00</span>
                           </div>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-3 col-md-4 col-sm-6">
                     <div class="tp-product-item-3 mb-50">
                        <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                           <a href="product-details-progress.php">
                              <img src="assets/img/product/3/product-7.jpg" alt="">
                           </a>
                        ...
                        <div class="tp-product-content-3">
                           ...
                           <h3 class="tp-product-title-3">
                              <a href="product-details-progress.php">Airspun Loose Face Powder</a>
                           </h3>
                           <div class="tp-product-price-wrapper-3">
                              <span class="tp-product-price-3 new-price">$24.00</span>
                              <span class="tp-product-price-3 old-price">$29.00</span>
                           </div>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-3 col-md-4 col-sm-6">
                     <div class="tp-product-item-3 mb-50">
                        <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                           <a href="product-details-progress.php">
                              <img src="assets/img/product/3/product-8.jpg" alt="">
                           </a>
                        ...
                        <div class="tp-product-content-3">
                           ...
                           <h3 class="tp-product-title-3">
                              <a href="product-details-progress.php">Grande Cosmetics Grande</a>
                           </h3>
                           <div class="tp-product-price-wrapper-3">
                              <span class="tp-product-price-3">$102.00</span>
                           </div>
                        </div>
                     </div>
                  </div>
         ...
         <section class="tp-collection-area pt-120">
            <div class="container">
               <div class="row gx-2 gy-2 gy-md-0">
                  <div class="col-xl-7 col-md-6">
                     <div class="tp-collection-item tp-collection-height grey-bg p-relative z-index-1 fix">
                        <div class="tp-collection-thumb include-bg include-bg transition-3" data-background="assets/img/product/collection/collection-1.jpg"></div>
                        <div class="tp-collection-content">
                           <span>Cosmetics Collection</span>
                           <h3 class="tp-collection-title">
                              <a href="shop.php">Foundation and <br> powder brush</a>
                           </h3>
                  ...
                  <div class="col-xl-5 col-md-6">
                     <div class="tp-collection-item tp-collection-height grey-bg p-relative z-index-1 fix">
                        <div class="tp-collection-thumb has-overlay include-bg transition-3" data-background="assets/img/product/collection/collection-2.jpg"></div>
                        <div class="tp-collection-content-1">
                           <h3 class="tp-collection-title-1">
                              <a href="shop.php">Tops <br> Blouse Shirts</a>
                           </h3>
                           <div class="tp-collection-btn-1">
                              <a href="shop.php" class="tp-link-btn-line">Shop Collection</a>
                           </div>
                        </div>
                     </div>
                  </div>
               ...
               <div class="row justify-content-center">
                  <div class="col-xl-3 col-lg-4 col-md-5">
                     <div class="tp-collection-offer-wrapper mt-20">
                        <p>Discover our Beauty Selection <span>75% Extra Discount</span> for your...</p>
                     </div>
                  </div>
                  <div class="col-xl-3 col-lg-4 col-md-5">
                     <div class="tp-collection-countdown d-flex align-items-center justify-content-center justify-content-md-start ml-20 mt-20">
                        ...
                        <div class="tp-product-countdown has-second" data-countdown data-date="Sep 30 2024 20:20:22">
                           <div class="tp-product-countdown-inner">
                              <ul>
                        ...
                        <div class="tp-product-tab-inner-3 d-flex align-items-center justify-content-center justify-content-lg-end">
                           <nav>
                              <div class="nav nav-tabs justify-content-center tp-product-tab tp-tab-menu p-relative" id="nav-tab" role="tablist">
                                ...
                                <button class="nav-link" id="nav-shoe-tab" data-bs-toggle="tab" data-bs-target="#nav-shoe" type="button" role="tab" aria-controls="nav-shoe" aria-selected="false">Trending
                                 <span class="tp-product-tab-tooltip">05</span>
                                </button>
                                <button class="nav-link" id="nav-clothing-tab" data-bs-toggle="tab" data-bs-target="#nav-clothing" type="button" role="tab" aria-controls="nav-clothing" aria-selected="false">Beauty
                                 <span class="tp-product-tab-tooltip">14</span>
                                </button>
                                <button class="nav-link" id="nav-bags-tab" data-bs-toggle="tab" data-bs-target="#nav-bags" type="button" role="tab" aria-controls="nav-bags" aria-selected="false" >Cosmetics
                           ...
                           <div class="row">
                              <div class="col-lg-3 col-md-4 col-sm-6">
                                 <div class="tp-product-item-3 mb-50">
                                    <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                                       <a href="product-details-progress.php">
                                          <img src="assets/img/product/3/product-9.jpg" alt="">
                                       </a>
                              ...
                              <div class="col-lg-3 col-md-4 col-sm-6">
                                 <div class="tp-product-item-3 mb-50">
                                    <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                                       <a href="product-details-progress.php">
                                          <img src="assets/img/product/3/product-10.jpg" alt="">
                                       </a>
                              ...
                              <div class="col-lg-3 col-md-4 col-sm-6">
                                 <div class="tp-product-item-3 mb-50">
                                    <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                                       <a href="product-details-progress.php">
                                          <img src="assets/img/product/3/product-11.jpg" alt="">
                                       </a>
                                    ...
                                    <div class="tp-product-content-3">
                                       ...
                                       <div class="tp-product-price-wrapper-3">
                                          <span class="tp-product-price-3 new-price">$73.00</span>
                                          <span class="tp-product-price-3 old-price">$82.00</span>
                                       </div>
                                    </div>
                                 </div>
                              </div>
                              <div class="col-lg-3 col-md-4 col-sm-6">
                                 <div class="tp-product-item-3 mb-50">
                                    <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                                       <a href="product-details-progress.php">
                                          <img src="assets/img/product/3/product-12.jpg" alt="">
                                       </a>
                                    ...
                                    <div class="tp-product-content-3">
                                       ...
                                       <div class="tp-product-price-wrapper-3">
                                          <span class="tp-product-price-3">$98.00</span>
                                       </div>
                                    </div>
                                 </div>
                              </div>
                           ...
                           <div class="row">
                              <div class="col-lg-3 col-md-4 col-sm-6">
                                 <div class="tp-product-item-3 mb-50">
                                    <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                                       <a href="product-details-progress.php">
                                          <img src="assets/img/product/3/product-13.jpg" alt="">
                                       </a>
                              ...
                              <div class="col-lg-3 col-md-4 col-sm-6">
                                 <div class="tp-product-item-3 mb-50">
                                    <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                                       <a href="product-details-progress.php">
                                          <img src="assets/img/product/3/product-14.jpg" alt="">
                                       </a>
                              ...
                              <div class="col-lg-3 col-md-4 col-sm-6">
                                 <div class="tp-product-item-3 mb-50">
                                    <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                                       <a href="product-details-progress.php">
                                          <img src="assets/img/product/3/product-15.jpg" alt="">
                                       </a>
                              ...
                              <div class="col-lg-3 col-md-4 col-sm-6">
                                 <div class="tp-product-item-3 mb-50">
                                    <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                                       <a href="product-details-progress.php">
                                          <img src="assets/img/product/3/product-16.jpg" alt="">
                                       </a>
                           ...
                           <div class="row">
                              <div class="col-lg-3 col-md-4 col-sm-6">
                                 <div class="tp-product-item-3 mb-50">
                                    <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                                       <a href="product-details-progress.php">
                                          <img src="assets/img/product/3/product-17.jpg" alt="">
                                       </a>
                              ...
                              <div class="col-lg-3 col-md-4 col-sm-6">
                                 <div class="tp-product-item-3 mb-50">
                                    <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                                       <a href="product-details-progress.php">
                                          <img src="assets/img/product/3/product-18.jpg" alt="">
                                       </a>
                              ...
                              <div class="col-lg-3 col-md-4 col-sm-6">
                                 <div class="tp-product-item-3 mb-50">
                                    <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                                       <a href="product-details-progress.php">
                                          <img src="assets/img/product/3/product-19.jpg" alt="">
                                       </a>
                              ...
                              <div class="col-lg-3 col-md-4 col-sm-6">
                                 <div class="tp-product-item-3 mb-50">
                                    <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                                       <a href="product-details-progress.php">
                                          <img src="assets/img/product/3/product-20.jpg" alt="">
                                       </a>
                  ...
                  <div class="col-xl-5 col-md-6">
                     <div class="tp-special-slider-thumb">
                        <div class="tp-special-thumb">
                           <img src="assets/img/product/special/big/special-big-1.jpg" alt="">
                                       ...
                                       <div class="swiper-wrapper">
                                          <div class="tp-special-item swiper-slide grey-bg-9">
                                             <div class="tp-product-item-3 mb-50 text-center">
                                                <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                                                   <a href="product-details-progress.php">
                                                      <img src="assets/img/product/special/special-1.jpg" alt="">
                                                   </a>
                                          ...
                                          <div class="tp-special-item swiper-slide grey-bg-9">
                                             <div class="tp-product-item-3 mb-50 text-center">
                                                <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                                                   <a href="product-details-progress.php">
                                                      <img src="assets/img/product/special/special-2.jpg" alt="">
                                                   </a>
                                                ...
                                                <div class="tp-product-content-3">
                                                   ...
                                                   <div class="tp-product-price-wrapper-3">
                                                      <span class="tp-product-price-3">$58.00</span>
                                                   </div>
                                                </div>
                                             </div>
                                          </div>
                           ...
                           <div class="swiper-wrapper">
                              <div class="tp-testimonial-item-3 swiper-slide grey-bg-7 p-relative z-index-1">
                                 ...
                                 <div class="tp-testimonial-content-3">
                                    <p>Suscipit tellus mauris a diam maecenas. Ut faucibus pulvinar elementum integer enim neque volutpat ac. Auctor urna nunc id cursus. Scelerisque purus semper eget duis at. Pharetra vel turpis nunc eget.</p>
                                 </div>
                                 <div class="tp-testimonial-user-wrapper-3 d-flex">
                                    <div class="tp-testimonial-user-3 d-flex align-items-center">
                                       ...
                                       <div class="tp-testimonial-user-3-info tp-testimonial-user-translate">
                                          <h3 class="tp-testimonial-user-3-title">Jake Weary  /</h3>
                              ...
                              <div class="tp-testimonial-item-3 swiper-slide grey-bg-7 p-relative z-index-1">
                                 ...
                                 <div class="tp-testimonial-user-wrapper-3 d-flex">
                                    <div class="tp-testimonial-user-3 d-flex align-items-center">
                                       ...
                                       <div class="tp-testimonial-user-3-info tp-testimonial-user-translate">
                                          <h3 class="tp-testimonial-user-3-title">Shahnewaz Sakil  /</h3>
                                          <span class="tp-testimonial-3-designation">Web Developer</span>
                                       </div>
                                    </div>
                                 </div>
                              </div>
                              <div class="tp-testimonial-item-3 swiper-slide grey-bg-7 p-relative z-index-1">
                                 ...
                                 <div class="tp-testimonial-user-wrapper-3 d-flex">
                                    <div class="tp-testimonial-user-3 d-flex align-items-center">
                                       ...
                                       <div class="tp-testimonial-user-3-info tp-testimonial-user-translate">
                                          <h3 class="tp-testimonial-user-3-title">Selina Gomz  /</h3>
                                          <span class="tp-testimonial-3-designation">CO Founder</span>
                                       </div>
                                    </div>
                                 </div>
               ...
               <div class="row row-cols-lg-6 row-cols-sm-2 row-cols-1 gx-2 gy-2 gy-lg-0">
                  <div class="col">
                     <div class="tp-instagram-item-2 w-img">
                        <img src="assets/img/instagram/3/instagram-1.jpg" alt="">
                        <div class="tp-instagram-icon-2">
                           <a href="assets/img/instagram/3/instagram-1.jpg" class="popup-image"><i class="fa-brands fa-instagram"></i></a>
                        </div>
                     </div>
                  </div>
                  <div class="col">
                     <div class="tp-instagram-item-2 w-img">
                        <img src="assets/img/instagram/3/instagram-2.jpg" alt="">
                        <div class="tp-instagram-icon-2">
                           <a href="assets/img/instagram/3/instagram-2.jpg" class="popup-image"><i class="fa-brands fa-instagram"></i></a>
                        </div>
                     </div>
                  </div>
                  <div class="col">
                     <div class="tp-instagram-item-2 w-img">
                        <img src="assets/img/instagram/3/instagram-3.jpg" alt="">
                        <div class="tp-instagram-icon-2">
                           <a href="assets/img/instagram/3/instagram-3.jpg" class="popup-image"><i class="fa-brands fa-instagram"></i></a>
                        </div>
                     </div>
                  </div>
                  <div class="col">
                     <div class="tp-instagram-item-2 w-img">
                        <img src="assets/img/instagram/3/instagram-4.jpg" alt="">
                        <div class="tp-instagram-icon-2">
                           <a href="assets/img/instagram/3/instagram-4.jpg" class="popup-image"><i class="fa-brands fa-instagram"></i></a>
                        </div>
                     </div>
                  </div>
                  <div class="col">
                     <div class="tp-instagram-item-2 w-img">
                        <img src="assets/img/instagram/3/instagram-5.jpg" alt="">
                        <div class="tp-instagram-icon-2">
                           <a href="assets/img/instagram/3/instagram-5.jpg" class="popup-image"><i class="fa-brands fa-instagram"></i></a>
                        </div>
                     </div>
                  </div>
                  <div class="col">
                     <div class="tp-instagram-item-2 w-img">
                        <img src="assets/img/instagram/3/instagram-6.jpg" alt="">
                        <div class="tp-instagram-icon-2">
                           <a href="assets/img/instagram/3/instagram-6.jpg" class="popup-image"><i class="fa-brands fa-instagram"></i></a>
                        </div>
                     </div>
                  </div>
               </div>
...
<!-- Mirrored from html.weblearnbd.net/shofy-prv/shofy/index-3.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Oct 2023 08:17:05 GMT -->
</html>
