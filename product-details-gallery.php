...
<!-- Mirrored from html.weblearnbd.net/shofy-prv/shofy/product-details-gallery.phpindex.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Oct 2023 08:19:07 GMT -->
<head>
      <meta charset="utf-8">
         ...
         <div class="offcanvas__wrapper">
            ...
            <div class="offcanvas__content">
               ...
               <div class="offcanvas__btn">
                  <a href="contact.phpindex.php" class="tp-btn-2 tp-btn-border-2">Contact Us</a>
               </div>
            </div>
            ...
            <div class="row row-cols-5">
               <div class="col">
                  <div class="tp-mobile-item text-center">
                     <a href="shop.phpindex.php" class="tp-mobile-item-btn">
               ...
               <div class="col">
                  <div class="tp-mobile-item text-center">
                     <a href="wishlist.phpindex.php" class="tp-mobile-item-btn">
               ...
               <div class="col">
                  <div class="tp-mobile-item text-center">
                     <a href="profile.phpindex.php" class="tp-mobile-item-btn">
         ...
         <div class="cartmini__wrapper d-flex justify-content-between flex-column">
             <div class="cartmini__top-wrapper">
                 ...
                 <div class="cartmini__widget">
                     <div class="cartmini__widget-item">
                         <div class="cartmini__thumb">
                           <a href="product-details.phpindex.php">
                              <img src="assets/img/product/product-1.jpg" alt="">
                           </a>
                         </div>
                         <div class="cartmini__content">
                           <h5 class="cartmini__title"><a href="product-details.phpindex.php">Level Bolt Smart Lock</a></h5>
                 ...
                 <div class="cartmini__empty text-center d-none">
                     ...
                     <a href="shop.phpindex.php" class="tp-btn">Go to Shop</a>
                 </div>
             </div>
             <div class="cartmini__checkout">
                 ...
                 <div class="cartmini__checkout-btn">
                     <a href="cart.phpindex.php" class="tp-btn mb-10 w-100"> view cart</a>
                     <a href="checkout.phpindex.php" class="tp-btn tp-btn-border w-100"> checkout</a>
                 </div>
             </div>
         </div>
     </div>
               ...
               <div class="container">
                  <div class="row">
                     <div class="col-xl-7 col-lg-6">
                        <div class="tp-product-details-thumb-gallery">
                           <div class="row">
                              <div class="col-lg-6">
                                 <div class="tp-product-details-thumb-gallery-item mb-25">
                                    <img src="assets/img/product/details/grid/product-details-grid-1.jpg" alt="">
                                 </div>
                              </div>
                              <div class="col-lg-6">
                                 <div class="tp-product-details-thumb-gallery-item mb-25">
                                    <img src="assets/img/product/details/grid/product-details-grid-2.jpg" alt="">
                                 </div>
                              </div>
                              <div class="col-lg-6">
                                 <div class="tp-product-details-thumb-gallery-item mb-25">
                                    <img src="assets/img/product/details/grid/product-details-grid-3.jpg" alt="">
                                 </div>
                              </div>
                              <div class="col-lg-6">
                                 <div class="tp-product-details-thumb-gallery-item mb-25">
                                    <img src="assets/img/product/details/grid/product-details-grid-4.jpg" alt="">
                                 </div>
                              </div>
                              <div class="col-lg-6">
                                 <div class="tp-product-details-thumb-gallery-item mb-25">
                                    <img src="assets/img/product/details/grid/product-details-grid-5.jpg" alt="">
                                 </div>
                              </div>
                              <div class="col-lg-6">
                                 <div class="tp-product-details-thumb-gallery-item mb-25">
                                    <img src="assets/img/product/details/grid/product-details-grid-6.jpg" alt="">
                                 </div>
                              </div>
                           </div>
                        </div>
                              ...
                              <div class="tp-product-item-3 tp-product-style-primary mb-50">
                                 ...
                                 <div class="tp-product-content-3">
                                    ...
                                    <h3 class="tp-product-title-3">
                                       <a href="product-details.phpindex.php">GalaxyS6 Android Tablet</a>
                                    </h3>
                           ...
                           <div class="swiper-slide">
                              <div class="tp-product-item-3 tp-product-style-primary mb-50">
                                 ...
                                 <div class="tp-product-content-3">
                                    ...
                                    <h3 class="tp-product-title-3">
                                       <a href="product-details.phpindex.php">Microsoft Surface Pro 8-13"</a>
                                    </h3>
                                    <div class="tp-product-price-wrapper-3">
                           ...
                           <div class="swiper-slide">
                              <div class="tp-product-item-3 tp-product-style-primary mb-50">
                                 ...
                                 <div class="tp-product-content-3">
                                    ...
                                    <h3 class="tp-product-title-3">
                                       <a href="product-details.phpindex.php">4K Digital Video Camera.</a>
                                    </h3>
                                    <div class="tp-product-price-wrapper-3">
                           ...
                           <div class="swiper-slide">
                              <div class="tp-product-item-3 tp-product-style-primary mb-50">
                                 ...
                                 <div class="tp-product-content-3">
                                    ...
                                    <h3 class="tp-product-title-3">
                                       <a href="product-details.phpindex.php">Discover Skincare watch</a>
                                    </h3>
                                    <div class="tp-product-price-wrapper-3">
...
<!-- Mirrored from html.weblearnbd.net/shofy-prv/shofy/product-details-gallery.phpindex.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Oct 2023 08:19:11 GMT -->
</html>
