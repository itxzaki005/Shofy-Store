...
<!-- Mirrored from html.weblearnbd.net/shofy-prv/shofy/compare.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Oct 2023 08:15:41 GMT -->
<head>
      <meta charset="utf-8">
                                 ...
                                 <td>
                                     <div class="tp-compare-thumb">
                                         ...
                                         <h4 class="tp-compare-product-title">
                                             <a href="product-details.php">Galaxy Tab S6 Lite 10.4-inch Android Tablet 128GB.</a>
                                         </h4>
                                     </div>
                                 </td>
                                 <td>
                                     <div class="tp-compare-thumb">
                                         ...
                                         <h4 class="tp-compare-product-title">
                                             <a href="product-details.php">Tracker with IP67 Waterproof Pedometer Smart watch.</a>
                                         </h4>
                                     </div>
                                 </td>
                                 <td>
                                     <div class="tp-compare-thumb">
                                         ...
                                         <h4 class="tp-compare-product-title">
                                             <a href="product-details.php">Cancelling Headphones Wireless Devices Blue.</a>
                                         </h4>
                                     </div>
                                 </td>
                                 <td>
                                     <div class="tp-compare-thumb">
                                         ...
                                         <h4 class="tp-compare-product-title">
                                             <a href="product-details.php">Professional Camera 4K Digital Video Camera.</a>
                                         </h4>
                                     </div>
                                 </td>
